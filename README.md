...
Full Stack Developer · Building reliable, maintainable apps and business systems

---

## About Me
I build end-to-end software that helps businesses run better — from ERP systems to industry websites and hospital management platforms. I enjoy solving real-world problems with practical code and shipping features that users rely on.

- 🔭 Current focus: ERP for Khushi Motors
- 🌱 Always learning: better UX, performance, and maintainable architecture
- 💬 Ask me about: full-stack app design, ERP implementations, vehicle industry websites, SEO management
- ⚡ Fun fact: "CODING CODING CODING" is my hobby.

---

## What I Build
- ERP systems tailored to business workflows (finance, inventory, sales, reporting)
- Vehicle-industry websites with SEO and conversion focus
- HMS — Hospital Management Systems (appointments, billing, records)
- Cross-platform apps and desktop tools with Electron
...
## Open to
- Contract work and long-term collaborations on ERPs, industry websites, and cross-platform apps
- Helping architect or refactor existing systems to scale with business needs
